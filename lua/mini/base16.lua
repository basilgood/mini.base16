...
H.apply_palette = function(palette, use_cterm)
  ...
  hi('NonText',      {fg=p.base02, bg=nil,      attr=nil,         sp=nil})
  ...
  hi('SpecialKey',   {fg=p.base02, bg=nil,      attr=nil,         sp=nil})
  ...
  hi('TabLineSel',   {fg=p.base04, bg=p.base00, attr=nil,         sp=nil})
  ...
  hi('VertSplit',    {fg=p.base02, bg=nil, attr=nil,         sp=nil})
  hi('Visual',       {fg=nil,      bg=p.base01, attr=nil,         sp=nil})
  hi('VisualNOS',    {fg=p.base08, bg=nil,      attr=nil,         sp=nil})
  hi('WarningMsg',   {fg=p.base08, bg=nil,      attr=nil,         sp=nil})
  hi('Whitespace',   {fg=p.base02, bg=nil,      attr=nil,         sp=nil})
  ...
  hi('Identifier',     {fg=p.base04, bg=nil,      attr=nil, sp=nil})
